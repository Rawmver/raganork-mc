...
module.exports = {
    ...
    RG: process.env.RG || '923082990885-923142478085@g.us,120363116963909366@g.us',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "LuciFER",
    BOT_NAME: process.env.BOT_NAME || 'LucIfer',
